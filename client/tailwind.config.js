...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Restaurant Green Primary (Fresh & Natural)
        primary: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
        ...
        // Warm Accent (Complementary to Green)
        accent: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
        ...
        surfaceHover: '#f1f5f9', // Slightly darker for hover states
        
        // Text Colors
        text: {
          primary: '#0f172a',    // Dark Blue-Gray (main text)
